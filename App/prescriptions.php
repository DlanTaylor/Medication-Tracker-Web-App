            ...
            <div class="card text-center text-primary mt-5">
                <div class="card-header">
                    <ul class="nav nav-pills card-header-pills">
                        <li class="nav-item">
                            <a class="nav-link active" id="createPrescription" href="#">Create Prescription</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link inactive" id="viewPrescriptions" href="#">View Prescriptions</a>
                        </li>
                    </ul>
                </div>
                <div class="card-body">
                    <div id="create">
                        <div class="form-group">
                            <input type="email" class="email form-control dtp" id="email" aria-describedby="emailHelp" placeholder="Email">
                        </div>
                        <div class="form-group">
                            <input class="form-control" id="prescription" placeholder="Name of Prescription">
                        </div>
                        <div class="form-group">
                            <input class="form-control" id="dosage" placeholder="Dosage">
                        </div>
                        <div class="form-group">
                            <textarea class="form-control" id="instruction" placeholder="Instructions of use"></textarea>
                        </div>
                        <div class="form-group">
